...
DRUG_CORRECTIONS = {
    ...
    "budescnide": "budesonide",
    "fluticascne": "fluticasone",
    "mcntelukast": "montelukast",
    "theophyllne": "theophylline", "theophy1line": "theophylline",
    "prednlsolone": "prednisolone",
    "prednlsone": "prednisone",
    "dexamethascne": "dexamethasone",
    # GI
    "omeprazcie": "omeprazole",
    "pantcprazole": "pantoprazole",
    "esomeprazcie": "esomeprazole",
    "ranitidne": "ranitidine", "ranitldine": "ranitidine",
    "cndansetron": "ondansetron",
    ...
    # Neuro / Psych
    "levetlracetam": "levetiracetam",
    "carbamazepne": "carbamazepine", "carbamazeplne": "carbamazepine",
    "phenytcin": "phenytoin",
    "valprclate": "valproate",
    "gabapentln": "gabapentin",
    "pregaballn": "pregabalin",
    "sertralme": "sertraline",
    "escltalopram": "escitalopram",
    "fluoxetme": "fluoxetine",
    "quetiaplne": "quetiapine",
    "olanzaplne": "olanzapine",
    "rlsperidone": "risperidone",
    "halopendol": "haloperidol",
    "dlazepam": "diazepam",
    "lcrazepam": "lorazepam",
    "mldazolam": "midazolam",
    "dcnepezil": "donepezil",
